...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04978a60a55a728d1d12608d432b33d5cce8405a4d39a7b50aa9d9e8a22e62b74e9882a52108072104ad3d0356e457751879dfbef27d051ce421968259184482fc");
        nDefaultPort = 7333;
        ...
        nTargetSpacing = 1.0 * 60; // 2.5 minutes
        nMaxTipAge = 24 * 60 * 60;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04978a60a55a728d1d12608d432b33d5cce8405a4d39a7b50aa9d9e8a22e62b74e9882a52108072104ad3d0356e457751879dfbef27d051ce421968259184482fc") << OP_CHECKSIG;
        ...
        // Insacoin: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("insacointools.com", "testnet-seed.insacointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.insacoin.loshan.co.uk"));
        ...
        // Insacoin: v2 enforced using Bitcoin's supermajority rule
